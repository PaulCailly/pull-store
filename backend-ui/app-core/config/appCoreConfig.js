...
const keycloakClientConfigAppConfig = appConfig.appCoreConfig?.keycloakClientConfig;
const keycloakClientConfig = {
  jwksEndpoint: keycloakClientConfigAppConfig?.jwksEndpoint ?? '',
};

const keycloakAuthConfigAppConfig = appConfig.appCoreConfig?.keycloakAuthConfig;
const keycloakAuthConfig = {
  username: keycloakAuthConfigAppConfig?.username ?? 'node-user',
  password: keycloakAuthConfigAppConfig?.password ?? 'Password should be provided',
  tokenExpOffset: keycloakAuthConfigAppConfig?.tokenExpOffset ?? 1000,
};
