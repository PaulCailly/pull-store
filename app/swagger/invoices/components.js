 ...
 *             payload:
 *               type: array
 *               description: This is an array of objects you want to store / pull, here invoices
 *               items:
 ...
 *             payload:
 *               type: object
 *               description: This is an object you want to store / pull, here invoice
 *               $ref: '#/components/schemas/invoicePayload'
 *     invoicePayload:
 *       type: object
 *       description: This is an object that represents all data of an invoice
 *       properties:
 *         _id:
 *           type: string
 *           description: This is a unique id that represents one invoice in MongoDB
 ...
 *     createSimpleInvoiceReq:
 *       type: object
 *       description: This is an object that represents the informations of invoice we want tot create
 *       properties:
 *         serviceReq:
 *           type: object
 *           properties:
 ...
 *             payload:
 *               $ref: '#/components/schemas/createInvoiceReqPayload'
 *     simpleInvoiceRes:
 *       type: object
 *       description: This is an object that will contain response about invoice creation/update in MongoDb
 *       properties:
 *         message:
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Invoice has successfully been added/update to the database
 *         code:
 *           type: integer
 *           description: This is a code that represents the status of all requests processed, 1 = success | 0 = fail
 *           example: 1
 ...
 *               example: 1
 *             payload:
 *               $ref: '#/components/schemas/invoiceIdsPayload'
 *     createMultipleInvoiceReq:
 *       type: object
 *       description: This is an object that will contain all data needed to create multiple invoices
 *       properties:
 *         serviceReq:
 *           type: object
 *           properties:
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Invoice has successfully been added/updated to the database
 *         code:
 *           type: integer
 *           description: This is a code that represents the status of all requests processed, 1 = success | 0 = fail
 *           example: 1
 ...
 *               items:
 *                 $ref: '#/components/schemas/invoiceIdsPayload'
 *     createInvoiceReqPayload:
 *       type: object
 *       description: This invoice payload is a fake until i change this one to the real payload
 *       properties:
 *         name:
 *           type: string
 *           description: This is the name of the invoice (will change in the future)
 *           example: invoice1
 *     invoiceIdsPayload:
 *       type: object
 *       description: This payload contains an id of an invoice (can be multiple if inside an array)
 *       properties:
 *         invoiceId:
 *           type: string
 *           description: This is the id of the (created, multiple, requested) invoice inside MongoDB
 *           example: 6257c8798554a3502f8aa2d3
 *     getInvoiceByIdsReq:
 *       type: object
 *       description: This is an object that will contain all data needed to get multiple invoices
 *       properties:
 *         serviceReq:
 *           type: object
 *           properties:
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Invoices have successfully been retrieved
 *         code:
 *           type: integer
 *           description: This is a code that represents the status of all requests processed, 1 = success | 0 = fail
 *           example: 1
 ...
 *               type: string
 *               description: This is a message centralized on only one request and how it has been processed
 *               example: Invoice successfully created
 *             serviceReqCode:
 *               type: integer
 *               description: This is a code that represents the status of only one request processed, 1 = success | 0 = fail
 *               example: 1
 ...
 *         serviceReq:
 *           type: array
 *           description: This is an array that will contain all data needed to update multiple invoices
 *           items:
 *             type: object
 *             properties:
 *               serviceReqId:
 ...
 *                 invoiceId:
 *                   type: string
 *                   description: This is the invoice id to update
 *                   example: 6259280e17322d1c45e7c453
 *                 updates:
 *                   type: object
 *                   description: This is a object that contains updates to apply on each id in the invoiceIds
 *                   properties:
 *                     Status:
 *                       type: integer
 *                       description: This is a value to update if process have been a success (1) or not (0)
 ...
 *     invoiceDeletedRes:
 *       type: object
 *       description: This response show if the invoice has been deleted or not
 *       properties:
 *         message:
 *           type: string
 *           description: this is the message that indicates details about deletion
 *           example: Invoice have successfully been deleted
 *         code:
 *           type: number
 ...
 *                 invoiceId:
 *                   type: string
 *                   description: The payload contains the id of the deleted invoice
 ...
 *                 count:
 *                   type: number
 *                   description: This is the amount of deleted invoices
 *                   example: 2
 *                 invoiceIds:
 *                   type: array
 *                   description: The payload contains the id of the deleted invoice
 ...
 *             payload:
 *               type: object
 *               description: This payload will contains all the informations you want from the invoice(s) requested
 *               properties:
 *                 filter:
 *                   type: object
 *                   description: This object contains filters you want to apply to the object (I only want invoices with this or this _id)
 *                   properties:
 *                     filter1:
 *                       type: object
 ...
 *                 columns:
 *                   description: This array will contains all informations you want ot retrieve from the invoice(s) requested
 *                   type: string
 *                   example:
 *                     - entry1
 *                     - entry2
 *                     - entry3
 *     getInvoiceSelectedColumnsRes:
 *       type: object
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Invoice have successfully been retrieved
 *         code:
 *           type: number
 ...
 *             payload:
 *               type: array
 *               description: This payload is an array of retrieved invoices
 *               items:
 *                 type: object
 *                 properties:
 *                   _id:
 *                     type: string
 *                     description: This is the id of the invoice inside the database
 ...
 *               example: 123e4567-e89b-12d3-a456-426614174000
 *             payload:
 *               $ref: '#/components/schemas/getInvoiceDistinctValuesReqPayload'
 *     getInvoiceDistinctValuesReqPayload:
 *       type: object
 ...
 *     updateMultipleInvoicesResponse:
 *       type: object
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Invoice have successfully been updated
 *         code:
 *           type: number
 ...
 *               example: Invoices have successfully been updated
 *             serviceReqCode:
 *               type: number
 *               description: this is the code that indicates details about update
 *               example: 1
