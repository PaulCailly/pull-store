 ...
 *             payload:
 *               type: array
 *               description: This is an array of objects you want to store / pull, here products
 *               items:
 ...
 *             payload:
 *               type: object
 *               description: This is an object you want to store / pull, here product
 *               $ref: '#/components/schemas/productPayload'
 *     productPayload:
 *       type: object
 *       description: This is an object that represents all data of an product
 *       properties:
 *         _id:
 *           type: string
 *           description: This is a unique id that represents one product in MongoDB
 ...
 *         otherData:
 *           type: string
 *           description: Not producted yet, could be array, object, string, number etc...
 *           example: Not producted yet, could be array, object, string, number etc...
 *     createSimpleProductReq:
 *       type: object
 *       description: This is an object that represents the informations of product we want tot create
 *       properties:
 *         serviceReq:
 *           type: object
 *           properties:
 ...
 *             payload:
 *               $ref: '#/components/schemas/createProductReqPayload'
 *     simpleProductRes:
 *       type: object
 *       description: This is an object that will contain response about product creation/update in MongoDb
 *       properties:
 *         message:
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Product has successfully been added/updated to the database
 *         code:
 *           type: integer
 *           description: This is a code that represents the status of all requests processed, 1 = success | 0 = fail
 *           example: 1
 ...
 *               type: string
 *               description: This is a message centralized on only one request and how it has been processed
 *               example: Product successfully created/updated
 *             serviceReqCode:
 *               type: integer
 *               description: This is a code that represents the status of only one request processed, 1 = success | 0 = fail
 *               example: 1
 *             payload:
 *               $ref: '#/components/schemas/productIdsPayload'
 *     createMultipleProductReq:
 *       type: object
 *       description: This is an object that will contain all data needed to create multiple products
 *       properties:
 *         serviceReq:
 *           type: object
 *           properties:
 ...
 *               items:
 *                 $ref: '#/components/schemas/productIdsPayload'
 *     createProductReqPayload:
 *       type: object
 *       description: This product payload is a fake until i change this one to the real payload
 *       properties:
 *         name:
 *           type: string
 *           description: This is the name of the product (will change in the future)
 *           example: product1
 *     productIdsPayload:
 *       type: object
 *       description: This payload contains an id of an product (can be multiple if inside an array)
 *       properties:
 *         productId:
 *           type: string
 *           description: This is the id of the (created, multiple, requested) product inside MongoDB
 *           example: 6257c8798554a3502f8aa2d3
 *     getProductByIdsReq:
 *       type: object
 *       description: This is an object that will contain all data needed to get multiple products
 *       properties:
 *         serviceReq:
 *           type: object
 *           properties:
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Products have successfully been retrieved
 *         code:
 *           type: integer
 *           description: This is a code that represents the status of all requests processed, 1 = success | 0 = fail
 *           example: 1
 ...
 *         serviceReq:
 *           type: array
 *           description: This is an array that will contain all data needed to update multiple products
 *           items:
 *             type: object
 *             properties:
 *               serviceReqId:
 ...
 *                 productId:
 *                   type: string
 *                   description: This is the product id to update
 *                   example: 6259280e17322d1c45e7c453
 *                 updates:
 *                   type: object
 *                   description: This is a object that contains updates to apply on each id in the productIds
 *                   properties:
 *                     Status:
 *                       type: integer
 *                       description: This is a value to update if process have been a success (1) or not (0)
 ...
 *     productDeletedRes:
 *       type: object
 *       description: This response show if the product has been deleted or not
 *       properties:
 *         message:
 *           type: string
 *           description: this is the message that indicates details about deletion
 *           example: Product have successfully been deleted
 *         code:
 *           type: number
 ...
 *                 productId:
 *                   type: string
 *                   description: The payload contains the id of the deleted product
 ...
 *                 count:
 *                   type: number
 *                   description: This is the amount of deleted products
 *                   example: 2
 *                 productIds:
 *                   type: array
 *                   description: The payload contains the id of the deleted product
 ...
 *             payload:
 *               type: object
 *               description: This payload will contains all the informations you want from the product(s) requested
 *               properties:
 *                 filter:
 *                   type: object
 *                   description: This object contains filters you want to apply to the object (I only want products with this or this _id)
 *                   properties:
 *                     filter1:
 *                       type: object
 ...
 *                 columns:
 *                   description: This array will contains all informations you want ot retrieve from the product(s) requested
 *                   type: string
 *                   example:
 *                     - entry1
 *                     - entry2
 *                     - entry3
 *     getProductSelectedColumnsRes:
 *       type: object
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Product have successfully been retrieved
 *         code:
 *           type: number
 ...
 *             payload:
 *               type: array
 *               description: This payload is an array of retrieved products
 *               items:
 *                 type: object
 *                 properties:
 *                   _id:
 *                     type: string
 *                     description: This is the id of the product inside the database
 ...
 *               example: 123e4567-e89b-12d3-a456-426614174000
 *             payload:
 *               $ref: '#/components/schemas/getProductDistinctValuesReqPayload'
 *     getProductDistinctValuesReqPayload:
 *       type: object
 ...
 *     updateMultipleProductsResponse:
 *       type: object
 ...
 *           type: string
 *           description: The global message of how requests have been processed
 *           example: Product have successfully been updated
 *         code:
 *           type: number
 ...
 *               example: Products have successfully been updated
 *             serviceReqCode:
 *               type: number
 *               description: this is the code that indicates details about update
 *               example: 1
